...
pub fn handle_cp2_push_sz(state: &mut Cp2ControllerState) {
...
pub fn handle_cp2_push_sxy(state: &mut Cp2ControllerState) {
...
pub fn handle_cp2_sxyp_mirror(state: &mut Cp2ControllerState) {
    let value = state.gd[14].read_u32();
    state.gd[15].write_u32(value);
}

pub fn handle_cp2_sxyp_write(state: &mut Cp2ControllerState, register_index: usize) {
...
pub fn handle_cp2_flag_reset(state: &mut Cp2ControllerState) {
    state.gc[31].write_u32(0);
}

pub fn handle_cp2_flag_error_bit(state: &mut Cp2ControllerState) {
...
pub fn handle_cp2_push_rgb(state: &mut Cp2ControllerState) {
...
pub fn get_cp0_register(state: &mut Cp0ControllerState, register_id: usize) -> &mut Register {
    match register_id {
        3 => &mut state.bpc,
        5 => &mut state.bda,
