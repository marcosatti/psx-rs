...
pub(crate) const _CHANNEL_NAMES: [&str; CHANNEL_COUNT] = ["MDECin", "MDECout", "GPU", "CDROM", "SPU", "PIO", "OTC"];
pub(crate) const DPCR_CHANNEL_ENABLE_BITFIELDS: [Bitfield; CHANNEL_COUNT] =
    [DPCR_MDECIN_ENABLE, DPCR_MDECOUT_ENABLE, DPCR_GPU_ENABLE, DPCR_CDROM_ENABLE, DPCR_SPU_ENABLE, DPCR_PIO_ENABLE, DPCR_OTC_ENABLE];
pub(crate) const DICR_IRQ_ENABLE_BITFIELDS: [Bitfield; CHANNEL_COUNT] =
...
pub(crate) const DICR_IRQ_FLAG_BITFIELDS: [Bitfield; CHANNEL_COUNT] =
...
pub(crate) const CHCR_CHOPPING_CPU_SIZE: Bitfield = Bitfield::new(20, 3);
