...
pub(crate) fn command_00_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, _data: &[u32]) {
}
...
pub(crate) fn command_01_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, _data: &[u32]) {
    // Flush cache (NOP)
}
...
pub(crate) fn command_02_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_05_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, _data: &[u32]) {
    // NOP
}
...
pub(crate) fn command_06_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, _data: &[u32]) {
    // NOP
}
...
pub(crate) fn command_0c_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, _data: &[u32]) {
    // NOP
}
...
pub(crate) fn command_28_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_2c_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_2d_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_30_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_38_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_3c_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_50_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_65_handler(_state: &State, gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
    ...
    let clut_mode = gpu_state.clut_mode;
    let texpage_base = Point2D::new(gpu_state.texpage_base_x, gpu_state.texpage_base_y);
...
pub(crate) fn command_6f_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_80_handler(_state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_a0_handler(_state: &State, _gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_c0_handler(state: &State, gpu_state: &mut ControllerState, video_backend: &VideoBackend, data: &[u32]) {
...
pub(crate) fn command_e1_handler(state: &State, gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
    ...
    gpu_state.transparency_mode = extract_texpage_transparency_mode(data[0]);

    let clut_mode_raw = Bitfield::new(7, 2).extract_from(data[0]);
    stat.write_bitfield(STAT_TEXPAGE_COLORS, clut_mode_raw);
    gpu_state.clut_mode = extract_texpage_clut_mode(data[0]);
    ...
    gpu_state.textured_rect_x_flip = Bitfield::new(12, 1).extract_from(data[0]) != 0;

    gpu_state.textured_rect_y_flip = Bitfield::new(13, 1).extract_from(data[0]) != 0;
...
pub(crate) fn command_e2_handler(_state: &State, gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
    ...
    gpu_state.texture_window_mask_y = Bitfield::new(5, 5).extract_from(data[0]) as usize;
    gpu_state.texture_window_offset_x = Bitfield::new(10, 5).extract_from(data[0]) as isize;
    gpu_state.texture_window_offset_y = Bitfield::new(15, 5).extract_from(data[0]) as isize;
...
pub(crate) fn command_e3_handler(_state: &State, gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
    ...
    gpu_state.drawing_area_y1 = Bitfield::new(10, 9).extract_from(data[0]) as usize;
...
pub(crate) fn command_e4_handler(_state: &State, gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
    ...
    gpu_state.drawing_area_y2 = Bitfield::new(10, 9).extract_from(data[0]) as usize;
    // warn!("GP0(E4h) not properly implemented");

    if (gpu_state.drawing_area_x2 != 0) || (gpu_state.drawing_area_y2 != 0) {
        // log::debug!("Non zero drawing area x2 y2: {}, {}", gpu_state.drawing_area_x2, gpu_state.drawing_area_y2);
    }
}
...
pub(crate) fn command_e5_handler(_state: &State, gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
    ...
    gpu_state.drawing_offset_x = ((x_offset << 5) >> 5) as isize;
    gpu_state.drawing_offset_y = ((y_offset << 5) >> 5) as isize;
...
pub(crate) fn command_e6_handler(state: &State, _gpu_state: &mut ControllerState, _video_backend: &VideoBackend, data: &[u32]) {
