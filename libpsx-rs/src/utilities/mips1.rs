...
pub(crate) fn pc_calc_jump_target(pc_value: u32, target: u32) -> u32 {
...
pub(crate) fn status_push_exception(status_value: u32) -> u32 {
...
/// recent copy.
pub(crate) fn status_pop_exception(status_value: u32) -> u32 {
    let ie_ku = status_value & 0x3F;
