...
pub unsafe fn sll(state: &State, instruction: Instruction) {
...
pub unsafe fn srl(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rt = &mut resources.r3000.gpr[instruction.rt()];
    let value = rt.read_u32();
    let shamt = instruction.shamt();
...
pub unsafe fn sra(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn sllv(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn srlv(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn srav(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn jr(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let target = resources.r3000.gpr[instruction.rs()].read_u32();
    resources.r3000.branch_delay.set(target, 1);
}

pub unsafe fn jalr(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let target = resources.r3000.gpr[instruction.rs()].read_u32();
    resources.r3000.branch_delay.set(target, 1);
...
pub unsafe fn syscall(state: &State, _instruction: Instruction) {
    let resources = &mut *state.resources;
    debug!("[{:X}] syscall, pc = 0x{:X}", DEBUG_TICK_COUNT, resources.r3000.pc.read_u32());
    set_exception(state, CAUSE_EXCCODE_SYSCALL);
}

pub unsafe fn break_(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction break not implemented");
}

pub unsafe fn mfhi(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn mthi(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
...
pub unsafe fn mflo(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn mtlo(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value = rs.read_u32();
...
pub unsafe fn mult(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
...
pub unsafe fn multu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
...
pub unsafe fn div(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
...
pub unsafe fn divu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn add(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn addu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn sub(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction sub not implemented");
}

pub unsafe fn subu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn and(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn or(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn xor(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn nor(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn slt(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32() as i32;
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn sltu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value1 = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn bltz(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn bgez(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let offset = (instruction.i_imm() as i32) << 2;
    let value = resources.r3000.gpr[instruction.rs()].read_u32() as i32;
...
pub unsafe fn bltzal(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction bltzal not implemented");
}

pub unsafe fn bgezal(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction bgezal not implemented");
}

pub unsafe fn j(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let target = pc_calc_jump_target(resources.r3000.pc.read_u32(), instruction.addr());
    resources.r3000.branch_delay.set(target, 1);
}

pub unsafe fn jal(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let target = pc_calc_jump_target(resources.r3000.pc.read_u32(), instruction.addr());
    resources.r3000.branch_delay.set(target, 1);
...
pub unsafe fn beq(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let offset = (instruction.i_imm() as i32) << 2;
...
pub unsafe fn bne(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let offset = (instruction.i_imm() as i32) << 2;
    let value1 = resources.r3000.gpr[instruction.rs()].read_u32();
    let value2 = resources.r3000.gpr[instruction.rt()].read_u32();
...
pub unsafe fn blez(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let offset = (instruction.i_imm() as i32) << 2;
    let value = resources.r3000.gpr[instruction.rs()].read_u32() as i32;
...
pub unsafe fn bgtz(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let offset = (instruction.i_imm() as i32) << 2;
    let value = resources.r3000.gpr[instruction.rs()].read_u32() as i32;
...
pub unsafe fn addi(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn addiu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn slti(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
...
pub unsafe fn sltiu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &mut resources.r3000.gpr[instruction.rs()];
    let value = rs.read_u32();
    let imm = instruction.i_imm() as i32 as u32;
...
pub unsafe fn andi(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn ori(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let rs = &resources.r3000.gpr[instruction.rs()];
    let value = rs.read_u32();
    let rt = &mut resources.r3000.gpr[instruction.rt()];
...
pub unsafe fn xori(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction xori not implemented");
}

pub unsafe fn lui(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn mfc0(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn mtc0(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn bc0f(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction bc0f not implemented");
}

pub unsafe fn bc0t(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction bc0t not implemented");
}

pub unsafe fn tlbr(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction tlbr not implemented");
}

pub unsafe fn tlbwi(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction tlbwi not implemented");
}

pub unsafe fn tlbwr(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction tlbwr not implemented");
}

pub unsafe fn tlbp(_state: &State, _instruction: Instruction) {
    unimplemented!("Instruction tlbp not implemented");
}

pub unsafe fn rfe(state: &State, _instruction: Instruction) {
    let resources = &mut *state.resources;
    let _lock = resources.r3000.cp0.mutex.lock();
...
pub unsafe fn lb(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn lh(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let mut addr = resources.r3000.gpr[instruction.rs()].read_u32();
    addr = addr.wrapping_add(instruction.i_imm() as i32 as u32);
    addr = translate_address(addr);
...
pub unsafe fn lwl(state: &State, instruction: Instruction) {
...
pub unsafe fn lw(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let mut addr = resources.r3000.gpr[instruction.rs()].read_u32();
    addr = addr.wrapping_add(instruction.i_imm() as i32 as u32);
    addr = translate_address(addr);
...
pub unsafe fn lbu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let mut addr = resources.r3000.gpr[instruction.rs()].read_u32();
    addr = addr.wrapping_add(instruction.i_imm() as i32 as u32);
    addr = translate_address(addr);
...
pub unsafe fn lhu(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
    let mut addr = resources.r3000.gpr[instruction.rs()].read_u32();
    addr = addr.wrapping_add(instruction.i_imm() as i32 as u32);
    addr = translate_address(addr);
...
pub unsafe fn lwr(state: &State, instruction: Instruction) {
...
pub unsafe fn sb(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn sh(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn swl(state: &State, instruction: Instruction) {
...
pub unsafe fn sw(state: &State, instruction: Instruction) {
    let resources = &mut *state.resources;
...
pub unsafe fn swr(state: &State, instruction: Instruction) {
