...
fn rtps_vector(resources: &mut Resources, shift: bool, vector_xy: u32, vector_z_: u32) {
    ...
    resources.r3000.cp2.gd[19].write_u32(sz3_value as u16 as u32);
    resources.r3000.cp2.gd[14].write_u16(0, sx2_value as i16 as u16);
    resources.r3000.cp2.gd[14].write_u16(1, sy2_value as i16 as u16);
    resources.r3000.cp2.gd[8].write_u32(ir0_value as u32);
    resources.r3000.cp2.gd[24].write_u32(mac0_value as i32 as u32);
...
pub fn rtps(resources: &mut Resources, instruction: Instruction) -> InstResult {
    ...
    rtps_vector(resources, instruction.sf(), vector_0_xy, vector_0_z_);
    Ok(())
}
...
pub fn nclip(resources: &mut Resources, _instruction: Instruction) -> InstResult {
    ...
    let sxy0 = resources.r3000.cp2.gd[12].read_u32();
    let sxy1 = resources.r3000.cp2.gd[13].read_u32();
    let sxy2 = resources.r3000.cp2.gd[14].read_u32();
...
pub fn avsz3(resources: &mut Resources, _instruction: Instruction) -> InstResult {
    ...
    let sz1 = resources.r3000.cp2.gd[17].read_u16(0) as f64;
    let sz2 = resources.r3000.cp2.gd[18].read_u16(0) as f64;
    let sz3 = resources.r3000.cp2.gd[19].read_u16(0) as f64;
    let (zsf3, _) = split_32_fixedi16_f64::<U12>(resources.r3000.cp2.gd[29].read_u32());
    ...
    resources.r3000.cp2.gd[7].write_u32(otz_value as i32 as u32);
    resources.r3000.cp2.gd[24].write_u32(mac0_value as i32 as u32);

    resources.r3000.cp2.gc[31].write_bitfield(Bitfield::new(15, 1), bool_to_flag(mac0_overflow_flag && mac0_negative_flag));
    resources.r3000.cp2.gc[31].write_bitfield(Bitfield::new(16, 1), bool_to_flag(mac0_overflow_flag && (!mac0_negative_flag)));
    resources.r3000.cp2.gc[31].write_bitfield(Bitfield::new(18, 1), bool_to_flag(otz_overflow_flag));
...
pub fn avsz4(resources: &mut Resources, _instruction: Instruction) -> InstResult {
    ...
    let sz0 = resources.r3000.cp2.gd[16].read_u16(0) as f64;
    let sz1 = resources.r3000.cp2.gd[17].read_u16(0) as f64;
    let sz2 = resources.r3000.cp2.gd[18].read_u16(0) as f64;
    let sz3 = resources.r3000.cp2.gd[19].read_u16(0) as f64;
    let (zsf4, _) = split_32_fixedi16_f64::<U12>(resources.r3000.cp2.gd[30].read_u32());
...
pub fn rtpt(resources: &mut Resources, instruction: Instruction) -> InstResult {
    ...
    let instruction = GteInstruction::new(instruction);
    for i in 0..3 {
        let vector_xy = resources.r3000.cp2.gd[i * 2 + 0].read_u32();
        let vector_z_ = resources.r3000.cp2.gd[i * 2 + 1].read_u32();
        rtps_vector(resources, instruction.sf(), vector_xy, vector_z_);
    }
