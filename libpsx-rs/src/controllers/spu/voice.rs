...
pub unsafe fn get_vollr(state: &State, voice_id: usize) -> *mut B32Register {
    let resources = &mut *state.resources;
    match voice_id {
        0 => &mut resources.spu.voice0_vollr as *mut B32Register,
        1 => &mut resources.spu.voice1_vollr as *mut B32Register,
        2 => &mut resources.spu.voice2_vollr as *mut B32Register,
        3 => &mut resources.spu.voice3_vollr as *mut B32Register,
        4 => &mut resources.spu.voice4_vollr as *mut B32Register,
        5 => &mut resources.spu.voice5_vollr as *mut B32Register,
        6 => &mut resources.spu.voice6_vollr as *mut B32Register,
        7 => &mut resources.spu.voice7_vollr as *mut B32Register,
        8 => &mut resources.spu.voice8_vollr as *mut B32Register,
        9 => &mut resources.spu.voice9_vollr as *mut B32Register,
        10 => &mut resources.spu.voice10_vollr as *mut B32Register,
        11 => &mut resources.spu.voice11_vollr as *mut B32Register,
        12 => &mut resources.spu.voice12_vollr as *mut B32Register,
        13 => &mut resources.spu.voice13_vollr as *mut B32Register,
        14 => &mut resources.spu.voice14_vollr as *mut B32Register,
        15 => &mut resources.spu.voice15_vollr as *mut B32Register,
        16 => &mut resources.spu.voice16_vollr as *mut B32Register,
        17 => &mut resources.spu.voice17_vollr as *mut B32Register,
        18 => &mut resources.spu.voice18_vollr as *mut B32Register,
        19 => &mut resources.spu.voice19_vollr as *mut B32Register,
        20 => &mut resources.spu.voice20_vollr as *mut B32Register,
...
pub unsafe fn get_adpcm_sr(state: &State, voice_id: usize) -> *mut B16Register {
    let resources = &mut *state.resources;
    match voice_id {
...
pub unsafe fn get_adpcm_sa(state: &State, voice_id: usize) -> *mut B16Register {
    let resources = &mut *state.resources;
    match voice_id {
...
pub unsafe fn get_adpcm_envelope(state: &State, voice_id: usize) -> *mut B32Register {
    let resources = &mut *state.resources;
    match voice_id {
...
pub unsafe fn get_adpcm_ra(state: &State, voice_id: usize) -> *mut B16Register {
    let resources = &mut *state.resources;
    match voice_id {
...
pub unsafe fn get_play_state(state: &State, voice_id: usize) -> *mut PlayState {
    let resources = &mut *state.resources;
    match voice_id {
