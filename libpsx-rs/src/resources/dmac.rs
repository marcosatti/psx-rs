...
pub fn initialize(resources: &mut Resources) {
    ...
    resources.r3000.memory_mapper.map::<u32>(0x1F80_1080, 4, &mut resources.dmac.mdecin_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_1084, 4, &mut resources.dmac.mdecin_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_1088, 4, &mut resources.dmac.mdecin_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_1090, 4, &mut resources.dmac.mdecout_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_1094, 4, &mut resources.dmac.mdecout_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_1098, 4, &mut resources.dmac.mdecout_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10A0, 4, &mut resources.dmac.gpu_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10A4, 4, &mut resources.dmac.gpu_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10A8, 4, &mut resources.dmac.gpu_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10B0, 4, &mut resources.dmac.cdrom_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10B4, 4, &mut resources.dmac.cdrom_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10B8, 4, &mut resources.dmac.cdrom_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10C0, 4, &mut resources.dmac.spu_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10C4, 4, &mut resources.dmac.spu_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10C8, 4, &mut resources.dmac.spu_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10D0, 4, &mut resources.dmac.pio_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10D4, 4, &mut resources.dmac.pio_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10D8, 4, &mut resources.dmac.pio_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10E0, 4, &mut resources.dmac.otc_madr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10E4, 4, &mut resources.dmac.otc_bcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10E8, 4, &mut resources.dmac.otc_chcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10F0, 4, &mut resources.dmac.dpcr as *mut B8MemoryMap);
    resources.r3000.memory_mapper.map::<u32>(0x1F80_10F4, 4, &mut resources.dmac.dicr as *mut B8MemoryMap);
}
